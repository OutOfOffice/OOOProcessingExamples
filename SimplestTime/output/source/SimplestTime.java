...
public class SimplestTime extends PApplet {
...
public void displayDigitalClock() {
  pushMatrix();
  pushStyle();
...
public void displayBandedClock() {
  pushMatrix();
  pushStyle();
...
public void displayNoisyDot() {
  ...
  float x = lerp(previousX, s+offsetX, 0.1f);
  previousX = x;
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SimplestTime" };
    if (passedArgs != null) {
